...
export enum View {
    ...
    DataNetworkPlaid = 'data-network-plaid',
    PaymentsStripe = 'payments-stripe',
    CardProgramsMarqeta = 'card-programs-marqeta',
    ModernTreasury = 'modern-treasury',
    OpenBanking = 'open-banking',
    FinancialDemocracy = 'financial-democracy',
    CryptoWeb3 = 'crypto-web3',
    AIAdStudio = 'ai-ad-studio',
    QuantumWeaverAI = 'quantum-weaver-ai',
    ...
    SovereignWealthSim = 'sovereign-wealth-sim',
