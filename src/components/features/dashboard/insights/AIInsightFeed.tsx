...
const MOCK_INSIGHTS: AIInsight[] = [
  {
    id: '1',
    title: 'Critical Spending Anomaly Detected',
    description: 'Unusual spike in "Entertainment" category detected over the last 48 hours.',
    detailedAnalysis: 'Our AI algorithms have detected a 25% deviation from your historical spending baseline in the Entertainment sector. This correlates with weekend activities but exceeds your set threshold of $200. Immediate review is recommended to maintain monthly liquidity targets.',
    category: 'spending',
    actionLabel: 'Audit Transactions',
    actionUrl: '/dashboard/transactions?filter=anomaly',
    severity: 'high',
    timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
    impactScore: 85,
    aiConfidence: 98,
    tags: ['anomaly', 'spending', 'alert'],
  },
  {
    id: '2',
    title: 'Tax-Loss Harvesting Opportunity',
    description: 'Potential to offset capital gains by liquidating underperforming assets.',
    detailedAnalysis: 'Market analysis indicates that your holdings in Sector X are currently down 12%. Realizing this loss now could offset the $4,000 gain realized in Q1, potentially saving you approximately $800 in tax liabilities based on your current bracket.',
    category: 'tax',
    ...
    impactScore: 60,
    aiConfidence: 92,
    tags: ['tax', 'investing', 'strategy'],
  },
  {
    id: '3',
    title: 'High-Yield Savings Optimization',
    description: 'Your emergency fund is underutilizing current interest rate environments.',
    detailedAnalysis: 'You are currently holding $15,000 in a standard savings account yielding 0.5%. Moving this to a High-Yield Savings Account (HYSA) at 4.5% APY would generate an additional $600 annually with zero additional risk.',
    category: 'savings',
  ...
  {
    id: '4',
    title: 'Subscription Redundancy Alert',
    description: 'Duplicate streaming services identified across multiple cards.',
    detailedAnalysis: 'Cross-referencing your credit card statements revealed concurrent subscriptions to "StreamPlus" and "StreamPlus Premium" on different payment methods. Consolidating these could save $180/year.',
    category: 'budgeting',
    ...
    impactScore: 30,
    aiConfidence: 95,
    tags: ['subscriptions', 'waste'],
  },
  {
    id: '5',
    title: 'Credit Utilization Warning',
    description: 'Approaching 30% utilization on Primary Visa card.',
    detailedAnalysis: 'Your current balance is $2,800 on a $10,000 limit. Crossing the 30% threshold may temporarily impact your credit score by 15-20 points. We recommend an early payment of $500 to maintain optimal scoring.',
    category: 'credit',
    ...
    impactScore: 75,
    aiConfidence: 90,
    tags: ['credit-score', 'utilization'],
  },
  {
    id: '6',
    title: 'Retirement Contribution Gap',
    description: 'You are on track to miss the annual 401(k) contribution limit.',
    detailedAnalysis: 'Based on your current contribution rate of $500/paycheck, you will fall $3,000 short of the federal maximum by year-end. Increasing contributions by $150/paycheck will maximize your tax-advantaged growth.',
    category: 'retirement',
  ...
  {
    id: '7',
    title: 'Debt Avalanche Strategy Available',
    description: 'AI simulation suggests a faster debt payoff route.',
    detailedAnalysis: 'Switching from your current random payment method to the Avalanche method (highest interest first) will save you $450 in interest over the next 12 months and clear your debt 2 months earlier.',
    category: 'debt',
...
const MOCK_KPIS: KPI[] = [
  {
    ...
    trend: 2.4,
    trendDirection: 'up',
    aiPrediction: 'Projected to hit $150k by Q3',
  },
  {
    id: 'kpi-2',
    ...
    aiPrediction: 'Optimized below regional average',
  },
  {
    id: 'kpi-3',
    ...
    trend: 15.0,
    trendDirection: 'up',
    aiPrediction: 'Potential for +$300 next month',
  },
  {
    id: 'kpi-4',
    ...
    trend: 1.2,
    trendDirection: 'up',
    aiPrediction: 'Top 10% of peer group',
  },
];
...
const MOCK_PROFILE: UserProfileAnalysis = {
  ...
  aiRecommendations: [
    'Increase umbrella insurance coverage based on asset growth.',
    'Rebalance portfolio to align with 60/40 target allocation.',
    'Setup living trust for estate planning optimization.',
  ],
};
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1 flex items-center gap-2">
              ...
              AI Engine v4.2 Active • Real-time Analysis
            </p>
          </div>
          <div className="flex items-center gap-3">
