...
// NOTE: ApiSettingsPage.css must be created separately or imported via global styles
...
const AIAdvisorView: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // NOTE: Update the endpoint if the backend is not running locally on 4000
      ...
      <form onSubmit={handleSubmit} className="settings-form">
        {activeTab === 'tech' ? (
          ...
          <>
            ...
            <div className="form-section">
              <h2>Open Banking (Major US/Global Banks)</h2>
            ...
            <div className="form-section">
              <h2>Real Estate & Property Data</h2>
            ...
            <div className="form-section">
              <h2>Fintech Utilities & Infrastructure</h2>
